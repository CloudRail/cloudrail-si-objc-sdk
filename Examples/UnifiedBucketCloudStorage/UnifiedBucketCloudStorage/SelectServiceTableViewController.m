...
- (void)viewDidLoad {
    ...
    _serviceNames = @[@"Amazon Web Services S3", @"Backblaze", @"Google Cloud Platform", @"Microsoft Azure Storage", @"Rackspace"];
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([[segue identifier] isEqualToString:@"serviceChosen"]) {
        ...
        ShowBucketsTableViewController *destViewController = (ShowBucketsTableViewController *)segue.destinationViewController;
